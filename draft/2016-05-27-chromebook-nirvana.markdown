...
This is a long, highly personal and autobigraphical tale about my emotional relationship with laptops. A lot of personal and probably irrelevant choices to you, regarding the history of computers I have owned. After a very long and dedicated relationship to ThinkPads, starting around the age of 10, I now have a Chromebook Pixel 2, running GalliumOS, and it is the best computing experience I have had up to this point. My position is slanted and unfair, and on top of that, I'm a linux user. If you are not interested in ThinkPads, linux as a daily driver, or the Chromebook Pixel, this is going to be very very boring.
...
This machine had an interesting feature that I tested to the extreme. The thinkpad had little holes at the bottom called keyboard drains, which routed liquid around critical components and into these drains if liquids were spilled on it. One night I was drinking a little heavily and watching cartoons in my bed, with a 24 ounce can of Coors balance next to the computer. I fell asleep, and when I awoke, the can was empty and the sheets were soaked. The computer was also soaked. The entire can of coors had gone through the keyboard and through the drains. The loop of episodes of aqua teen I was watching were still playing. My little thinkpad had soft, warm, beer smelling breath coming out of the CPU vent on the side. 

I was even deeper in love. This event strenghtend our relationship, as both computer and I had beer on our breat at inappropriate times, namely first thing in the morning before work. We were one in the same.

#### Consultant badass

The next move was to ThoughtWorks, as a devops and automation consultant. They give you the option of a Dell or Apple product upon joining. As a man of principle who was used to having a real package manager and OS that was uncrippled and production-like, I opted for the Dell, left windows on it, and put it in my living room to watch porn and drive my sound system. I spent my relocation package on a top of the line refurb thinkpad x220s. The world balked at Lenovo's drop in build quality, but I didn't care. This machine lasted me over half a million miles in 2 years of near constant travelling to different clients, through new batteries, more memory, and SSD upgrades. I dropped it regularly, it's covered in dents. I had full disk encryption and an SSD before Apple products did. I was running tons of vagrant VMs with ease on my tiny workhorse of a machine. We stayed together through thick and thin, until an unfortunate accident involving leaving the computer outside in a beach town all night. The moisture shorted out one of the memory sockets, and I used it for another 2 years with 8 instead of 16GB of memory. 

During that time, I convinced my journalist girlfriend who was complaning after her mac was stolen that the way forward was to get a refurb thinkpad. She wanted a machine that was indescrtuctoible, light, and cheap. Upon receipt of her computer she immediately destroyed the keyboard somehow and had to replace it on her own. The ease in which she did it with no help produced another recruit into the ThinkPad army.

#### The tragedy of modern Lenovo

I upgraded horizontally to an x230 when I got a new job, because my x220 was so beat up looking that I was little ashamed to use it with my new collegues. Once again it was a great machine, even with the treasonous chicklet style keyboard, and movement of the arrow clusters. This didn't bother me as much as it bothered the hardcores I suppose. As long as the trackpoint stayed and I could disable the touchpad entirely, I was happy.

However, the resolution started to get to me after a while. I was doing a lot of web design and presentation work, and was limited by the 1024x768. My friend accurately described it as "Computing through a periscope". It was more than fine for coding in tmux and vim, and browsing the web, but when it came to building websites, my resolution was lower than most users, so I couldn't see what they saw accurately. I needed to upgrade.

I bought a Chromebook Pixel 2 and a Thinkpad X1 Carbon 4th Gen... at the same time. I wanted to be able to see which I liked better, and wound up returning both for different reasons.

The X1 was simply too big for me, after nearly 16 years of conditioning of carrying a tiny 12" computer around, the 14" felt absurd and clownish. The resolution was too high for text editing without doing serious surgery on some applications, or making the fonts huge, which worked okay, but HiDPI in XFCE really wasn't figured out yet. I couldn't read the menus in most applications, and had to zoom most browsing up to 150% or 200%, which caused strange behavior on many responsive sites. Nothing was consistent, and I was left feeling pretty dejected and annoyed with everything I had to do with it. I couldn't get it configured to a state that I felt was usable. I wound up returning it after about a month.

The Pixel 2 I also returned. I installed Crouton on it and tried to do real work. I didn't have full disk encryption. Linux felt like a second class citizen. I didn't like having to use my google account for logging into my own machine. The whole hackery just felt too ugly. I'm not at all belittling the efforts of the crouton developers in any way. I couldn't believe that any of it worked at all, and was amazed with the command line only work I had to do. When it came to using GUI linux software, like browsers and GIMP, the same problems reared their heads. Copying and pasting between the native ChromeOS browser and the linux terminal didn't work, and swithcing between them was clumsy. Browsing from inside linux was had the same HiDPI problems in Gnome and XFCE. I installed xubuntu on it natively next, and it was a comedy of errors and a huge undertaking to configure, with similiar problems to the X1. Sound didn't work properly. The wifi was dodgy. The touchpad features were not available and made using it incredibly frustrating. The battery life was terrible. I felt screwed. I returned it and went back to using my x230, as the x240 had not been released yet.


#### A chance meeting with GalliumOS

I was doing more design work, and once again got the itch for a new machine. I looked around again, and saw that the x240 had been released, and nearly pulled the trigger on it, until I saw a story on HN about GalliumOS. I read up about it and didn't believe what I saw. Someone had dedicated time and resources to making everything work on a chromebook under linux, and making it beautiful to boot. I couldn't resist and bought another Pixel 2 and haven't looked back since. 

It is simply the best experience I have ever had using a computer. Collegues are jealous. Everything works, including the (slightly annoying) touchscreen pinch to zoom stuff. Keyboard lighting, power management, encryption, and media keys. It's a real linux box wrapped in the sexiest pi
